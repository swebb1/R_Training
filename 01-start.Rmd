...
<br>
We recommend using [RStudio](https://rstudio.com/) for this workshop. [RStudio](https://www.rstudio.com/) is an Integrated Development Environment (IDE) for R. It can be accessed in several ways:

* Sign in to Rstudio on the bifx servers
  + [bifx-cli](bifx-cli.bio.ed.ac.uk:8787) (RStudio)
  + [bifx-core2](bifx-core2.bio.ed.ac.uk:8787) (RStudio Pro - UoE Network only)
* Download [RStudio](https://rstudio.com/) and install it on your own computer.
