...
exercises: 50
objectives:
  - Learn to create graphics with ggplot2
  - Learn how additional packages can enhance these graphics
keypoints:
...
First, make sure you have loaded all of the required packages and datasets:
...
Add ‘geoms’ – graphical representations of the data in the plot (points, lines, bars). ggplot2 offers many different geoms, here are a few commonly used examples:
