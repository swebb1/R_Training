...
R has many functions for statistical testing. Please see our [introduction to stats](https://drive.google.com/open?id=1qG_4Dzxc9x3yDnkhjInFKSUGdEHmn2shW2Sj6KwSc_A) document for more information on distributions, hypothesis testing and statistical significance. 
...
<h2><i class="fas fa-thumbtack"></i> **IMPORTANT:**</h2>
...
<div class="discussion">
<h2><i class="far fa-bell"></i> Consider the following:</h2>
##
